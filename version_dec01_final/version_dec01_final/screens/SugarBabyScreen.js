...
const SugarBabyScreen = ({ navigation }) => {
  ...
  const sugarBabies = [
    {
      ...
      premium: true,
      location: 'Budapest',
      lookingFor: 'Gazdag partnert keresek',
    },
    {
      id: 2,
      name: 'Eszter',
  ...
  const filteredProfiles = sugarBabies.filter(profile => {
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Sugar Baby</Text>
          <View style={styles.placeholder} />
        </View>

        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.infoCard}>
            <Ionicons name="sparkles" size={32} color="#FF6B9D" />
            <Text style={styles.infoTitle}>Prémium Társkeresés</Text>
            <Text style={styles.infoText}>
              Találj fiatal, szép partnereket, akik készek támogatást nyújtani.
            </Text>
          </View>
...
export default SugarBabyScreen;
