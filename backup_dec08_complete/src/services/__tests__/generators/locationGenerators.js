...
/**
 * Generate a pair of locations (any distance)
 * 
 ...
 * 
 * @example
 * const locationPair = locationPairWithDistanceGenerator(5, 50);
 */
export const locationPairWithDistanceGenerator = (minDistanceKm = 0, maxDistanceKm = 100) => {
...
/**
 * Generate a pair where both locations are the same (for identity tests)
 */
export const sameLocationGenerator = locationGenerator.map(loc => [loc, { ...loc }]);

/**
 * Generate a pair of locations with known distance
 * Used for testing distance calculation accuracy
 */
export const knownDistanceGenerator = fc.constantFrom(
  {
    location1: { latitude: 47.4979, longitude: 19.0402 }, // Budapest
    location2: { latitude: 47.5316, longitude: 21.6273 }, // Debrecen
    expectedDistance: 193, // km
    tolerance: 5 // km
  },
  {
    location1: { latitude: 47.4979, longitude: 19.0402 }, // Budapest
    location2: { latitude: 46.2530, longitude: 20.1414 }, // Szeged
    expectedDistance: 166, // km
    tolerance: 5 // km
  },
  {
    location1: { latitude: 47.4979, longitude: 19.0402 }, // Budapest
    location2: { latitude: 46.0727, longitude: 18.2324 }, // Pécs
    expectedDistance: 165, // km
    tolerance: 5 // km
  }
);
 ...
 */
export const locationListGenerator = fc.array(locationGenerator, { minLength: 3, maxLength: 10 });
